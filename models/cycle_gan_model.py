...
class CycleGANModel(BaseModel):
    ...
    def backward_D_basic(self, netD, real, fake):
        ...
        loss_D_fake = torch.mean(pred_fake) #This is for cycle WGAN-GP
        #loss_D_fake = self.criterionGAN(pred_fake, False) #This is initial cycleGAN
    ...
    def optimize_parameters(self):
        ...
        self.backward_G(retain_graph=True)             # calculate gradients for G_A and G_B
        self.optimizer_G.step()       # update G_A and G_B's weights




        #self.optimizer_D.zero_grad()   # set D_A and D_B's gradients to zero #implementing WGAN
        #self.backward_D_A()      # calculate gradients for D_A #implementing WGAN
        #self.backward_D_B()      # calculate graidents for D_B #implementing WGAN
        #self.optimizer_D.step()  # update D_A and D_B's weights #implementing WGAN
